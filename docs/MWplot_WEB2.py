...
rsun=8.125
ingaia="/Users/mmessine/GAIA-DR3/DR3_bprp_WISEtest/strangeness/TableAB_xyVlsr2.csv"
...
get_fig(im,scale_x,scale_y,No_x,No_y,rsun,xr,yr,'MWrsg2.eps',"Mbol < -5")
